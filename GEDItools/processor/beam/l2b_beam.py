...
class L2BBeam(Beam):
    ...
    @staticmethod
    def load_field_mapping(file_path: str = "l2b_field_mapping.yml") -> dict:
    ...
    def quality_filter(self):
        ...
        quality_filters = self.quality_filter_config["quality_filters"]["level_2b"]
    ...
    def _get_main_data_dict(self) -> dict:
        ...
        if "absolute_time" in self.field_mapping["general_data"]:
            ...
            data["absolute_time"] = gedi_l2b_count_start + pd.to_timedelta(self[delta_time_source], unit="seconds")
