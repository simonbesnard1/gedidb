...
The :py:class:`gedidb.GEDIProvider` class is your main tool for querying GEDI data from the [tile]DB database. The following example demonstrates how to configure and use the provider to retrieve data with options to include additional quality filters for customized data refinement.
