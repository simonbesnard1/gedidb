...
extlinks = {
    "issue": ("https://git.gfz-potsdam.de/global-land-monitoring/gedi-toolbox/issues/%s", "GH%s"),
    "pull": ("https://git.gfz-potsdam.de/global-land-monitoring/gedi-toolbox/pull/%s", "PR%s")
}
...
ogp_image = "https://gedi-toolbox.readthedocs.io/en/latest/_static/logos/gediDB_logo.png"
...
def linkcode_resolve(domain, info):
    ...
    if "+" in gedidb.__version__:
        return f"https://git.gfz-potsdam.de/global-land-monitoring/gedi-toolbox/blob/main/xarray/{fn}{linespec}"
    else:
        return (
