...
class GEDIProvider(TileDBProvider):
    ...
    def get_data(
        ...
        **quality_filters : dict
        ...
        return (
            self.to_xarray(scalar_data, metadata)
    ...
    def to_xarray(self, scalar_data: Dict[str, np.ndarray], metadata: pd.DataFrame) -> xr.Dataset:
        """
